...
class VaillantTab(QWidget):
    def __init__(self, parent = None):
        ...
        self.tools_layout = pw.createButtonList([['assign common material', acm.assignCommonShader_xray],['select non-Redshift materials', self.testProc]], label = '03. Assign Materials', cols = 1)
